...
class AddParent extends Component
{
    ...
    // show the form wizard affter click add new parents
    ...
    // methode for submit the form wizaard form
        ...
        try {
            ...
            if (!empty($this->photos)) {
                foreach ($this->photos as $photo) {
                    $photo->storeAs($this->National_ID_Father, $photo->getClientOriginalName(), $disk = 'cherki_hamza_file_upload_path');
    ...
    public function submitForm_edit()
    {
        ...
        flash()->addSuccess('The Parent Informations Updated with successfully');
    ...
    public function delete($id)
    {
        ...
        flash()->addError('The Parent Deleted successfully');
        return redirect()->route('show_form');
    }
