...
<div style="display: none" class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            <div class="form-row">
                <div class="col">
                    <label for="title">{{trans('dashboard.Name_Mother')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Name_Mother_en')}}</label>
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <label for="title">{{trans('dashboard.Job_Mother')}}</label>
                ...
                <div class="col-md-3">
                    <label for="title">{{trans('dashboard.Job_Mother_en')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.National_ID_Mother')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Passport_ID_Mother')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Phone_Mother')}}</label>
            ...
            <div class="form-group">
                <label for="exampleFormControlTextarea1">{{trans('dashboard.Address_Mother')}}</label>
            ...
            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="button"
                wire:click="secondStepSubmit">{{trans('dashboard.Next')}}</button>
            @endif
