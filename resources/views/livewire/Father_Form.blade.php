...
<div style="display: none" class="row setup-content" id="step-1">
    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            <div class="form-row">
                <div class="col">
                    <label for="title">{{trans('dashboard.Email')}} </label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Password')}}</label>
            ...
            <div class="form-row">
                <div class="col">
                    <label for="title">{{trans('dashboard.Name_Father')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Name_Father_en')}}</label>
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <label for="title">{{trans('dashboard.Job_Father')}}</label>
                ...
                <div class="col-md-3">
                    <label for="title">{{trans('dashboard.Job_Father_en')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.National_ID_Father')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Passport_ID_Father')}}</label>
                ...
                <div class="col">
                    <label for="title">{{trans('dashboard.Phone_Father')}}</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCity">{{trans('dashboard.Nationality_Father_id')}}</label>
                    <select class="custom-select my-1 mr-sm-2" wire:model="Nationality_Father_id">
                        ...
                        <option value="{{$National->id}}">{{$National->nationalite_name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col">
                    <label for="inputState">{{trans('dashboard.Blood_Type_Father_id')}}</label>
                    <select class="custom-select my-1 mr-sm-2" wire:model="Blood_Type_Father_id">
                        <option selected>{{trans('dashboard.Choose')}}...</option>
                        @foreach($Type_Bloods as $Type_Blood)
                        <option value="{{$Type_Blood->id}}">{{$Type_Blood->blod_name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col">
                    <label for="inputZip">{{trans('dashboard.Religion_Father_id')}}</label>
            ...
            <div class="form-group">
                <label for="exampleFormControlTextarea1">{{trans('dashboard.Address_Father')}}</label>
            ...
            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmit_edit"
                type="button">{{trans('dashboard.Next')}}
            </button>
            @else
