...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ route('admin') }}"><img
                src="{{ asset('public/assets/images/ch.png') }}" alt=""></a>
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <div class="btn-group mb-1">
            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown"
                ...
                @else
                {{ LaravelLocalization::getCurrentLocaleName() }}
                <img src="{{ URL::asset('public/assets/images/flags/US.png') }}" alt="">
                @endif
            </button>
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                    ...
                    <span>
                        <img src="{{ URL::asset('public/assets/images/flags/SA.png') }}" alt="">
                        {{ $properties['native'] }}
                    </span>
                    @else
                    <img src="{{ URL::asset('public/assets/images/flags/FR.png') }}" alt="">
                    {{ $properties['native'] }}
                    @endif
        ...
        {{-- <li class="nav-item dropdown mr-30">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                aria-expanded="false">
                <img src="{{ asset('public/assets/images/profile-avatar.jpg') }}" alt="avatar">
            </a>
